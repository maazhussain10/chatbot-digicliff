...
class Query {
    ...
    runQuery(app) {
        ...
        app.post('/createQuery', (req, res) => {
            let { rows, selectedColumns, distinctColumn, userId, assistantId, intentId, tableName } = req.query;
            ...
            sqlFunctions.addQueryDetails(rows, selectedColumns, distinctColumn, userId, assistantId, intentId, tableName);
