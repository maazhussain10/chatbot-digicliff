...
class Entity extends Component {
        ...
        try {
            axios({
                ...
                for (let i = 0; i < response.data.length; i++) {
                    ...
                    $('#' + response.data[i].entityType + '-delete').removeClass('invisible');
    ...
    selectColumn = (entityType) => {
        ...
        $('#' + entityType + '-delete').removeClass('invisible');
    }
    ...
    removeColumn = (entityType) => {
        ...
        $('#' + entityType + '-delete').addClass('invisible');
    }
    functions = () => {
        $(function () {
                                        ...
                                        <div className="row">
                                            <div className="col-md-5">
                                                <div className="custom-control custom-switch">
                                                    ...
                                                    <img src="https://img.icons8.com/ios-filled/20/4a90e2/info.png" aria-hidden="true" data-toggle="tooltip" data-placement="right" title={entityDetails[index]} />
                                                </div>
                                            </div>
                                            <input id={entity + "-input"} className="col-md-6 form-control invisible" />
                                            <button onClick={() => this.deleteEntity(entity)} id={entity + "-delete"} type="button" className="btn btn-sm btn-outline-danger col-md-1 invisible" >
