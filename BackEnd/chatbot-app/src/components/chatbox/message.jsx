            ...
            return (
                <div>
                    <div className="chatbox-sender">
                        <div className="s-content" style={{ backgroundColor: userBg }}>
                            <span className="text" style={{ color: userColor, fontFamily: userFont }}>{messages[0]}</span>
                        </div>
                                    ...
                                    <React.Fragment>
                                            ...
                                            <div key={index} className="chat-conversion">
                                                {load[index] ?
                                                    <div className="reciever-load">
                                                        ...
                                                        <h1 className="load-dot first"><span></span></h1>
                                                        <h1 className="load-dot second"><span></span></h1>
                                                        <h1 className="load-dot third"><span></span></h1>
                                                        <h1 className="load-dot fourth"><span></span></h1>
                                                        {this.sleepTime(index)}
                                                    </div>
                                                    :
                                                    <React.Fragment>
                                                        <div className="n-content" style={{ backgroundColor: assistantBg }}>
                                                            <span key={index} style={{ color: assistantColor, fontFamily: assistantFont }} className="text">{message}</span>
                                                        </div>
                                        ...
                                        {load[load.length - 1] ? null :
                                            <RichResponse
                                                ...
                                                cardTheme={cardTheme}
                                                chipTheme={chipTheme} />}
                                        {load[load.length - 1] ? null : <span className="time">{time}</span>}
