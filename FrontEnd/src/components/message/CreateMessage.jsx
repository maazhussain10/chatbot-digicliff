...
const CreateMessage = (props) => {
    ...
    const addMessage = async () => {
        try {
            ...
            const response = await messageService.create(props.intentId, props.messageType, message, accessToken, setAccessToken)
                    ...
                    <div className="card-body">
                        <div className="input-group input-group-lg">
                            ...
                            <pre
                                ...
                                style={{ textAlign: "left", whiteSpace: "pre-wrap", height: "auto", fontSize: "1rem" }}
