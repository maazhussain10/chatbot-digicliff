                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="d-flex justify-content-end">
                                ...
                                <button onClick={() => {
                                    props.setHostName(props.chatbot.hostName)
                                    props.setSelectedChatbot(props.chatbot)
                                }} type="button" data-toggle="modal" data-target="#embedscript" className="btn btn-sm btn-outline-info mr-1">
