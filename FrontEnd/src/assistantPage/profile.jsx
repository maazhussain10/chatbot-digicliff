                    ...
                    <nav className="navbar navbar-expand-lg navbar-light sticky-to container">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul className="ml-auto navbar-na text-center nav nav-pills" id="pills-tab" role="tablist">
                                ...
                                <li className="nav-item" role="presentation">
                                    <a className="nav-link" id="pills-assistant-tab" data-toggle="pill" href="#pills-assistant" role="tab" aria-controls="pills-assistant" aria-selected="false">Assitants   <span className="badge badge-light">{existingAssistant.length}</span></a>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <a
                                        className="nav-link" id="pills-integs-tab" data-toggle="pill" href="#pills-integs" role="tab" aria-controls="pills-integs" aria-selected="false">Integrations</a>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <a
                                        className="nav-link" id="pills-stats-tab" data-toggle="pill" href="#pills-stats" role="tab" aria-controls="pills-stats" aria-selected="false">Stats</a>
                                </li>
                            </ul>
